...
public class Baseclass {
    ...
    public void testLogin() {
        try {
            ...
            WebElement LoginButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*[@id=\"root\"]/div/div[3]/div[1]/div[2]/button)[1]")));  // Adjust the locator as needed
            LoginButton.click();
