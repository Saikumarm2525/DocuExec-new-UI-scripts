package docuexec.completeProfile;
...
//		Thread.sleep(4000);
	...
	public void changepasswordCancel() throws Exception {
		...
		otpField.sendKeys(otp);
		// Click cancel button
		WebElement CancelButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[2]/span")));
		CancelButton.click();
	...
	public void Editname() throws Exception {
		...
		try { // Click OK on the message
			...
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[2]/div[1]/div[2]/div/img")).click();// edit full name
			driver.findElement(By.xpath("//*[@id=\"profileName\"]")).clear();// clear the name field
			driver.findElement(By.xpath("//*[@id=\"profileName\"]")).sendKeys(name);// enter full name
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[1]/span")).click();// click save changes btn
			Thread.sleep(3000);
			try {
			...
			driver.findElement(By.xpath("//*[@id=\"mobileOTPid\"]")).sendKeys(otp);// entering mobile OTP
			driver.findElement(By.xpath("//*[@id=\"emailOTPid\"]")).sendKeys(otp);// entering email OTP
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[1]/span")).click();// click submitchanges btn
		} catch (Exception e) {
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[1]/span")).click();// Edit profile button click
			Thread.sleep(2000);
...
//		driver.navigate().to(uaturl + "/accountInfo");
	...
	public void Editmail() throws Exception {
		...
		try { // Click OK on the message
			...
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[2]/div[3]/div[2]/div/img")).click();// edit full email
			driver.findElement(By.xpath("//*[@id=\"profileEmailID\"]")).clear();// clear the email field
			driver.findElement(By.xpath("//*[@id=\"profileEmailID\"]")).sendKeys(mail);// enter mail
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[1]/span")).click();// click save changes btn
			Thread.sleep(3000);
			try {
				driver.findElement(By.xpath("//*[@id=\"react-confirm-alert\"]/div/div/div/div/button")).click();// click
...
//		driver.navigate().to(uaturl + "/accountInfo");
	...
	public void Editmobilenumber() throws Exception {
		...
		try { // Click OK on the message
			...
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[2]/div[2]/div[2]/div/img")).click();// edit full name
			driver.findElement(By.xpath("//*[@id=\"mobileNumber\"]")).clear();// clear the name field
			driver.findElement(By.xpath("//*[@id=\"mobileNumber\"]")).sendKeys(mob);// enter full name
			driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[3]/div/div[3]/div[1]/span")).click();// click save changes btn
			Thread.sleep(3000);
			try {
				driver.findElement(By.xpath("//*[@id=\"react-confirm-alert\"]/div/div/div/div/button")).click();// click
	...
	public void DeleteAccount() throws Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"defaultBackGround\"]/div[2]/div[1]/div/div[2]/div/div[3]/div/span")).click();// clicking proceed btn
		Thread.sleep(3000);
		try {
			driver.findElement(By.xpath("//*[@id=\"react-confirm-alert\"]/div/div/div/div/button")).click();// click ok
		} catch (Exception e) {
			driver.findElement(By.cssSelector("//*[@id=\"DelteAccuntOTP\"]")).click();// click ok
		}
		Thread.sleep(3000);
