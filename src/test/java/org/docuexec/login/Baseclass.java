...
public class Baseclass {
    ...
    public void testLogin() {
        try {
            ...
            WebElement LoginButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[normalize-space(text())='login']")));  // Adjust the locator as needed
            LoginButton.click();
...
//		driver.navigate().to(Stagingurl + "/accountInfo");
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(/html/body/div/div/header/ul[2]/li[2]/a)[1]")).click();//click on name
		Thread.sleep(2000);
		driver.findElement(By.xpath("(/html/body/div/div/header/ul[2]/li[2]/div/button[3])[1]")).click();//click on login
